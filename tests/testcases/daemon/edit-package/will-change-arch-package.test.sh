...
tests:eval :describe-package curl arch-repo testing testing-db x86_64 package_one
tests:assert-re stdout "This is test package description"

:edit-package-description curl arch-repo testing testing-db x86_64 package_one "New description"
tests:eval :describe-package curl arch-repo testing testing-db x86_64 package_one
